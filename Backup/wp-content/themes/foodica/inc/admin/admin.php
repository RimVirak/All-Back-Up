	...
	function foodica_welcome_notice() {
		...
		<div class="notice notice-success wpz-welcome-notice">
			...
			<p class="wpz-welcome-notice-button">
				...
				<a class="button-primary" href="<?php echo esc_url(__('https://www.wpzoom.com/themes/foodica/', 'foodica')); ?>" target="_blank">
			...
			<div class="wpz-row theme-intro wpz-clearfix">
				...
				<div class="wpz-col-3-4 theme-description">
                    ...
                    <div class="theme-links wpz-clearfix">
                        <p>
                            <a href="<?php echo esc_url(__('https://www.wpzoom.com/themes/foodica/', 'foodica')); ?>" class="button button-primary" target="_blank">
				...
				<div class="wpz-row wpz-clearfix">
					...
					<div class="wpz-col-1-2">
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url(__('https://www.wpzom.com/themes/foodica/', 'foodica')); ?>" target="_blank" class="button button-primary">
									<?php esc_html_e('Upgrade to Foodica PRO', 'foodica'); ?>
								</a>
							</p>
						</div><hr /><br/>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td></td>
							<td>
								<a href="<?php echo esc_url(__('https://www.wpzoom.com/themes/foodica/', 'foodica')); ?>" target="_blank" class="upgrade-button">
									<?php esc_html_e('Upgrade to Foodica PRO', 'foodica'); ?>
								</a>
							</td>
						</tr>
